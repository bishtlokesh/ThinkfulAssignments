...
def preProcess(Data):
   ...
   # data_sub=Data['Amount.Funded.By.Investors']
    #print(data_sub)
    #py.boxplot(data_sub)
    Data.boxplot(column='Amount.Funded.By.Investors')
   # py.show()
    Data.hist(column='Amount.Funded.By.Investors')
   # Data.qq(column='Amount.Funded.By.Investors')
    py.show()
    stats.probplot(Data['Amount.Funded.By.Investors'], dist='norm', plot=py)
    py.show()
    return Data
